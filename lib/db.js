...
async function createSaasListing({
  ...
  await client`
    INSERT INTO saas_listings
      (slug, name, tagline, description, website_url, category, launch_year, submitter_email, base_score, tier, engine)
    VALUES
      (${slug}, ${name}, ${tagline || null}, ${description || null}, ${websiteUrl}, ${category || null},
       ${launchYear || null}, ${submitterEmail || null}, ${baseScore}, ${tier}, ${engine || null})
  `;
  return slug;
}
